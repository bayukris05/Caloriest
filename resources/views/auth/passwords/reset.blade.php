...
<head>
    ...
    <title>Ubah Kata Sandi - Caloriest</title>
    ...
    <div class="login-container">
        <div class="left-section">
            <div class="sign-in-form">
                <h1 class="sign-in-header">Buat Kata Sandi Baru</h1>
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="password-confirm" name="password_confirmation" required placeholder="Ulangi kata sandi">
                    </div>

                    <button type="submit" class="btn-signin">Reset Kata Sandi</button>
                </form>
            </div>
        </div>
