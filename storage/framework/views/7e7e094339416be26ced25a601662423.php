<?php if(auth()->guard()->check()): ?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('css/recomend.css')); ?>">
    ...
    <body>
        ...
        <header class="header">
            <h1 class="greeting">Halo <?php echo e(Auth::user()->name); ?></h1>
        ...
        <main class="main-container">
            <section class="section" style="background: transparent;" id="recommendationsSection">
                <div class="food-cards-container" style="background: transparent;" id="foodCardsContainer">
                    <?php $__currentLoopData = $pageRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php $__currentLoopData = $row; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="food-card">
                                    <div class="food-card-image">
                                        ...
                                        <?php else: ?>
                                            <div class="food-card-fallback"
                                                style="background: linear-gradient(45deg, <?php echo e($item->image_color ?? '#4caf50'); ?>);">
                                                <span><?php echo e(substr($item->name, 0, 15)); ?></span>
                                            </div>
                                        <?php endif; ?>
                                        <div class="food-card-badge">
                                            <span>⭐</span> <?php echo e($item->calorie_range); ?>
                                    ...
                                    <div class="food-card-content">
                                        ...
                                        <button class="food-card-button" onclick="saveMenu('<?php echo e($item->name); ?>', '<?php echo e($item->calorie_range); ?>')">Simpan Menu</button>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
        ...
        <div class="popup-overlay" id="menuListPopup">
            <div class="popup-container">
                <img src="<?php echo e(asset('images/chef.png')); ?>" alt="Menu Header" class="popup-header-image">
...
<?php endif; ?>
<?php /**PATH D:\lomba\TrackCalorie\resources\views/auth/recomend.blade.php ENDPATH**/ ?>